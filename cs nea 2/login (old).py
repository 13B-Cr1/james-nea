...
class AuthApp:
    def __init__(self, root):
        ...
        self.signup_success_frame = ttk.Frame(root)
    ...
    def create_login_frame(self):
        ...
        # self.login_password.place(relx=0.5, rely=0.5, anchor=CENTER)
    ...
    def handle_login(self):
        ...
        # If the username and the password doesn't work:
        if not username and not password:
            messagebox.showerror("Error", "Please fill in the username and the password.")
            return
        
        elif not password:
            messagebox.showerror("Errow", "Please fill in the password.")
            return
    ...
    def handle_signup(self):
        ...
        if not username or not password or not confirm_password:
            ...
            messagebox.showerror("Error", "Please fill in the pasword.")
            return

...
class UserManager:
    ...
    def reset_password(self, identifier, new_password):  # FIXED METHOD
        self.cursor.execute("""
        ...
        # Only update password_hash - REMOVED PASSWORD COLUMN REFERENCE
        self.cursor.execute("""
            UPDATE users 
            SET password_hash = ?
            WHERE username = ?
...
class AuthApp:
    ...
    def handle_signup(self, data):
        try:
            ...
            messagebox.showinfo("Success", "Account created successfully! \n please remember your details before you click off!")
            self.show_frame("login")
    ...
    def handle_reset_password(self, data):
        try:
            ...
            # Pass identifier and new_password directly
            self.user_manager.reset_password(
                data['identifier'],
                data['new_password']  # No need for confirm_password here
            )
